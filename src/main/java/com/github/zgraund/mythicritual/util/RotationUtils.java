...
public class RotationUtils {
     ...
     */
    public static Vec3i rotate(Vec3i offset, @Nonnull Direction facing) {
     ...
     */
    @Nonnull
    public static BlockPos relativeTo(@Nonnull BlockPos anchor, Vec3i offset, Direction facing) {
