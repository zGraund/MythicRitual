...
public final class ModRegistries {
    ...
    public static final ResourceKey<Registry<MapCodec<? extends RitualCondition>>> CONDITION_REGISTRY_KEY =
    ...
    public static final Registry<MapCodec<? extends RitualCondition>> CONDITION_REGISTRY = new RegistryBuilder<>(CONDITION_REGISTRY_KEY).sync(true).create();
}
